...
public class Clock extends View {
    ...
    private void drawHoursValues(Canvas canvas) {
        ...
        for(int i = 0;i < FULL_ANGLE;i += 30){
            int cx = (int) (mCenterX + 400 * Math.sin(Math.toRadians(i)));
            int cy = (int) (mCenterX - 400 * Math.cos(Math.toRadians(i)));
    ...
    private void drawCenter(Canvas canvas) {
        ...
        canvas.drawCircle(mCenterX,mCenterX,20,paint1);

        Paint paint2 = new Paint();
        paint2.setColor(centerInnerColor);
        paint2.setStyle(Paint.Style.FILL);
        canvas.drawCircle(mCenterX,mCenterX,20,paint2);
    }
